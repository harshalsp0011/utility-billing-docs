...
<html lang="en" data-content_root="" >
  ...
  <head>
    ...
    <title>Vendoring Policy &#8212; Utility Billing AI Documentation</title>
...
const thebe_selector_output = ".output, .cell_output"
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.10/site-packages/pip/_vendor/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.venv/lib/python3.10/site-packages/pip/_vendor/README.rst" target="_blank"
...
for all dependencies for successful debundling.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib/python3.10/site-packages/pip/_vendor"
        },
